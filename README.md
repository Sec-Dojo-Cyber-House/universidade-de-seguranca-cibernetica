...
1. Introdução e Segurança Cibernetica
2. Red Team - Curso Iniciante Gratuito
3. Blue Team - Curso Iniciante Gratuito
4. Prática Bônus de CTF e Útimos CVEs
5. Bônus Windows
6. Salas Extremamente Difíceis de Fazer - As tarefas são lineares em natureza de dificuldade. Então é recomendado fazê-las em ordem. Mas você ainda pode pular e pular algumas salas se achar que já está familiarizado com os conceitos.

Conforme você avança no curso, você encontrará emblemas de conclusão que estão ocultos neste [README.md](https://github.com/Sec-Dojo-Cyber-House/universidade-de-seguranca-cibernetica/tree/main/README.md) para emblemas de conclusão do caminho de Red e Blue Team. Você pode copiar o código HTML para eles e adicioná-lo à página de conteúdo abaixo depois de concluí-los.
